...
{
    public class CargoPayTypesManager : Manager<CargoPayTypesVM, CargoPayTypes, int>, ICargoPayTypesManager
    {
        public CargoPayTypesManager(ICargoPayTypesRepo repo, IMapper mapper)
